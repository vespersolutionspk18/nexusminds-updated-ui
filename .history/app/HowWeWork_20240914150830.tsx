...
const HowWeWork = () => {
  return (
    <div className="flex flex-col items-center justify-center mt-36">
        ...
        <h3 className="text-center font-semibold text-slate-800 md:text-5xl text-3xl">Time is money.<br></br>With Nexus Minds you save both</h3>
        ...
        <div className=" rounded-2xl bg-purple-700 px-1 py-1">
            <div className="bg-blueprint-image h-[220px] w-full bg-cover bg-center rounded-[16px]"></div>
        </div>
        ...
        <div className="w-full md:w-1/4">
        <div className=" rounded-2xl bg-purple-700 px-1 py-1">
            <div className="bg-prototyping-image h-[220px] w-full bg-cover bg-center rounded-[16px]"></div>
        </div>
        ...
        <div className="w-full md:w-1/4">
        <div className=" rounded-2xl bg-purple-700 px-1 py-1">
            <div className="bg-devlopment-image h-[220px] w-full bg-cover bg-center rounded-[16px]"></div>
        </div>
        ...
        <div className="w-full md:w-1/4">
        <div className=" rounded-2xl bg-purple-700 px-1 py-1">
            <div className="bg-support-image h-[220px] w-full bg-cover bg-left rounded-[16px]"></div>
        </div>
