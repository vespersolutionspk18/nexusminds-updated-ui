...
<div className=" mx-5 md:mx-10 flex flex-row  my-2 rounded-3xl bg-radial-gradient pt-16 md:pt-32  pb-16">
        ...
        <div className="flex flex-col md:flex-row items-start justify-between ">
          <div className="md:w-[40%]  my-2 "><h5 className="text-2xl font-semibold">Consulting</h5></div>
        ...
        <div className="flex md:flex-row flex-col items-start justify-between ">
          <div className="md:w-[40%]  my-2 md:mx-0"><h5 className="text-2xl font-semibold">Development</h5></div>
        ...
        <SeparatorPurple />
        <div className="flex md:flex-row flex-col items-start justify-between ">
          <div className="md:w-[40%]  my-2 md:mx-0"><h5 className="text-2xl font-semibold">Cloud Migration</h5></div>
        ...
        <SeparatorPurple />
        <div className="flex md:flex-row flex-col items-start justify-between ">
          <div className="md:w-[40%]  my-2 md:mx-0"><h5 className="text-2xl font-semibold">Modernization</h5></div>
        ...
        <SeparatorPurple />
        <div className="flex md:flex-row flex-col items-start justify-between ">
          <div className="md:w-[40%]  my-2 md:mx-0"><h5 className="text-2xl font-semibold">Support & Maintenance</h5></div>
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <h3 className="font-semibold text-2xl md:text-4xl text-slate-800">Cloud Deployment Models</h3>
          ...
          <div className="w-full flex flex-row items-center justify-center px-12 mx-10 md:mx-0 md:px-20 mt-10 gap2-"><CloudCarousel />
</div>
        </div>
        <ContactSection />
        <Footer />
