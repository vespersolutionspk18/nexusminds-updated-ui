...
<div className=" mx-10 flex flex-row  my-2 rounded-3xl bg-radial-gradient pt-16 md:pt-32  pb-16">
        ...
        <div className="flex flex-col items-center justify-center">
          <div className="flex flex-row items-center justify-center mt-20 mx-20">
            ...
            <h5 className="font-normal text-2xl pl-32 pr-64 text-slate-800">Cloud software development services vary. We’ll help you choose the best one based on your needs, security, and compliance.</h5>
          </div>
