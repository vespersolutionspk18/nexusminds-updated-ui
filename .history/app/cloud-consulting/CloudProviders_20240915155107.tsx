...
const CloudProviders = () => {
  return (
    <div className="flex flex-col items-center justify-center mt-36">
        ...
        <p className="text-lg font-regular text-slate-800 mt-2 mb-10 md:mb-0 font-justify">Developing your ideas into blueprints for digital success. Quick, collaborative sessions to define the roadmap.</p>
        </div>
        <div className="w-full md:w-1/4">
        <div className=" rounded-2xl bg-purple-700 px-1 py-1">
