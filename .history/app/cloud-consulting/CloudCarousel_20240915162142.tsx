...
export function CloudCarousel() {
  const items = [
    { precursor: "Scenario 1", title: "Public", description: "Our cloud development team has years of hands-on experience designing accessible and user-friendly public cloud products. Services distributed across multiple data centers mean reduced overhead and extra flexibility." },
          ...
          <CarouselItem key={index}>
            <div className="p-1">
              <div className=" px-0 py-10 flex flex-row items-start justify-between">
                ...
                <p className="text-slate-800 pr-20">{item.description}</p></div>
              </div>
            </div>
          </CarouselItem>
        ))}
