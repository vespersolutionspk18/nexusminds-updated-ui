...
const CloudProviders = () => {
  return (
    <div className="flex flex-col items-center justify-center mt-36">
        ...
        <p className="text-lg font-regular text-slate-800 mt-2 mb-10 md:mb-0">Heroku is a versatile platform-as-a-service that supports multiple programming languages and is a preferred choice for Nexus as a Heroku Partner. It enables the creation, operation, and management of cloud-based applications. Heroku’s platform speeds up app development and offers a ready-to-use environment for rapid code deployment, making it ideal for startups and mid-sized businesses.</p>
        </div>
