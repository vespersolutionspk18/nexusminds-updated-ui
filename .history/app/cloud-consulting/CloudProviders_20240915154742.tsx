...
const CloudProviders = () => {
  return (
    <div className="flex flex-col items-center justify-center mt-36">
        ...
        <p className="text-lg px-10 md:px-20 text-slate-800 mt-3 text-center">We strategically choose the optimal development toolkit for your custom cloud solution to ensure that your stack integrates smoothly with any major cloud service provider.</p>
        </div>
