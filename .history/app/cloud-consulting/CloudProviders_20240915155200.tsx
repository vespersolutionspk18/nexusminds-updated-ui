...
const CloudProviders = () => {
  return (
    <div className="flex flex-col items-center justify-center mt-36">
        ...
        <p className="text-lg font-regular text-slate-800 mt-2 mb-10 md:mb-0 font-justify">We utilize GCP&apos;s global reach, extensive fiber network, and analytics to enhance the productivity of your cloud computing solutions, no matter where your business operates. Google Cloud&apos;s range of computing services and data management, powered by AI, is an essential resource for any contemporary company.</p>
        </div>
        <div className="w-full md:w-1/4">
        <div className=" rounded-2xl bg-purple-700 px-1 py-1">
