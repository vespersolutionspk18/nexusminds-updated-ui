...
const Header = () => {
  ...
  id="button"
  className="group  bg-slate-700 h-[44px] flex-row font-sans text-white text-[16px] py-1 px-1 font-regular rounded-full hidden md:flex items-center justify-between w-[200px] transition-width duration-500 ease-in-out hover:shadow-[6px_6px_12px_rgba(0,0,0,0.6),-6px_-6px_12px_rgba(255,255,255,0.3)] hover:w-[225px] hover:bg-purple-700"
