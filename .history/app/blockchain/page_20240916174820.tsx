...
<div className=" mx-5 md:mx-10 flex flex-row  my-2 rounded-3xl bg-radial-gradient pt-16 md:pt-32  pb-16">
        ...
        <div className="flex flex-col md:flex-row items-start justify-between ">
          <div className="md:w-[40%] mx-0 my-2 md:mx-0"><h5 className="text-2xl font-semibold">Custom blockchain app development</h5></div>
        ...
        <div className="flex md:flex-row flex-col items-start justify-between ">
          <div className="md:w-[40%] mx-0 my-2 md:mx-0"><h5 className="text-2xl font-semibold">Smart Contracts Development</h5></div>
        ...
        <SeparatorPurple />
        <div className="flex md:flex-row flex-col items-start justify-between ">
          <div className="md:w-[40%] mx-0 my-2 md:mx-0"><h5 className="text-2xl font-semibold">Crypto exchange and wallet development</h5></div>
        ...
        <SeparatorPurple />
        <div className="flex md:flex-row flex-col items-start justify-between ">
          <div className="md:w-[40%] mx-0 my-2 md:mx-0"><h5 className="text-2xl font-semibold">Decentralized (dApp) development</h5></div>
        ...
        <SeparatorPurple />
        <div className="flex md:flex-row flex-col items-start justify-between ">
          <div className="md:w-[40%] mx-0 my-2 md:mx-0"><h5 className="text-2xl font-semibold">Non-fungible Token Development</h5></div>
          <div className="md:w-[60%]"><p className="text-justify">We convert digital assets into unreplicable NFTs and offer advice on the best way to deploy NFT technologies to give your business the boost it needs.</p></div>
        </div>
