...
<div className=" mx-10 flex flex-row  my-2 rounded-3xl bg-radial-gradient pt-16 md:pt-32  pb-16">
        ...
        <SeparatorPurple />
        <div className="flex md:flex-row flex-col items-start justify-between ">
          <div className="md:w-[40%] mx-2 my-2 md:mx-0"><h5 className="text-2xl font-semibold">Non-fungible token (NFT) development</h5></div>
          <div className="md:w-[60%]"><p className="text-justify">We convert digital assets into unreplicable NFTs and offer advice on the best way to deploy NFT technology.</p></div>
        </div>
