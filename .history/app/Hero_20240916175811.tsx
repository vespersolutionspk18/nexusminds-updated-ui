        ...
        <div className="md:mx-10 mx-5 flex flex-row  my-2 rounded-3xl bg-radial-gradient pt-16 md:pt-32  pb-16">
            <div id="left content of hero" className="mx-10 md:mx-20 my-5 md:my-10 w-full md:w-1/2">
                ...
                <div id="buttons container" className="mt-7 flex flex-row">
                    <div
                    id="button"
                    className="group bg-[#ffffffa1] hover:bg-white h-[44px] flex-row font-sans text-slate-800 text-[16px] py-1 px-1 font-regular rounded-full flex items-center justify-between w-[165px] transition-width duration-500 ease-in-out hover:transition-width hover:ease-in-out hover:w-[180px] hover:shadow-[6px_6px_12px_rgba(0,0,0,0.6),-6px_-6px_12px_rgba(255,255,255,0.3)]"
