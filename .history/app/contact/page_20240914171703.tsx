...
const page = () => {
  ...
  <Card className="mx-auto">
    ...
    <div>
    <div class="calendly-inline-widget" data-url="https://calendly.com/nexusmindstech-info/project-onboarding?primary_color=8300ff" style={{ minWidth: '320px', height: '700px' }}></div>
