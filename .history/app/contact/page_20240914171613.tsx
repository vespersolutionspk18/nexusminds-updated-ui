...
const page = () => {
  ...
  return (
    <div>
      <Header />
        ...
        <div id="contains the form" className=" mx-10">
  <Card className="mx-auto">
    ...
    <CardContent>
      <div className="grid gap-4">
        ...
        <div className="flex items-center justify-center">
          <div id="button" className="group bg-slate-700 h-[44px] flex-row font-sans text-white text-[16px] py-1 px-1 font-regular rounded-full flex items-center justify-between w-[120px] transition-width duration-500 ease-in-out hover:transition-width hover:ease-in-out hover:w-[148px] hover:bg-purple-700">
            <div className="mx-3">
              Submit
            </div>
    ...
    <>
    <div className="calendly-inline-widget" data-url="https://calendly.com/nexusmindstech-info/project-onboarding?hide_gdpr_banner=1&primary_color=8300ff" style={{ minWidth: '320px', height: '700px' }}></div>
