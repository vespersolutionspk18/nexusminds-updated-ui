  ...
  return (
    <div className="flex flex-col mx-10  rounded-2xl">
        ...
        <div id="footer first row" className="flex lg:flex-row flex-col justify-between ">
            ...
            <div className="flex flex-col gap-3 items-start justify-normal">
            <Image
  src="/assets/nexuslogo.svg"
  alt="logo"
  
  width={330} // Base width
  height={120} // Base height (aspect ratio will be maintained)
  className="md:w-[330px] md:h-[120px] w-[150px] h-[140px]"
  onClick={homeClick}
/>
