...
<div className=" mx-5 md:mx-10 flex flex-row  my-2 rounded-3xl bg-radial-gradient pt-16 md:pt-32  pb-16">
        ...
        <div className="flex flex-col md:flex-row items-start justify-between ">
          <div className="md:w-[40%] mx-0 my-2 md:mx-0"><h5 className="text-2xl font-semibold">Mobile Technology Consulting</h5></div>
        ...
        <div className="flex md:flex-row flex-col items-start justify-between ">
          <div className="md:w-[40%] mx-0 my-2 md:mx-0"><h5 className="text-2xl font-semibold">UI / UX Design & Development</h5></div>
        ...
        <SeparatorPurple />
        <div className="flex md:flex-row flex-col items-start justify-between ">
          <div className="md:w-[40%] mx-0 my-2 md:mx-0"><h5 className="text-2xl font-semibold">Ongoing Enhancement</h5></div>
