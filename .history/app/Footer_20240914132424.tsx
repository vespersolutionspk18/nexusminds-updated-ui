  ...
  return (
    <div className="flex flex-col mx-10  rounded-2xl">
        ...
        <div id="footer first row" className="flex lg:flex-row flex-col justify-between ">
            <div className="flex flex-row items-start justify-center gap-10 lg:gap-20">
        ...
        <div>
            ...
            <p className="font-light text-sm text-slate-800">OneSafe is a financial technology company, not a bank.</p>
        </div>
        </div>
    </div>
  )
