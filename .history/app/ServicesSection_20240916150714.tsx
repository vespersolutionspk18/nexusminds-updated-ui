    ...
    <div>
        ...
        <div className="md:w-1/2 w-full flex flex-row  md:pr-24 items-start justify-start gap-0 mt-5 md:mt-0 px-10 md:px-0">
            <div className="flex flex-col gap-3  w-1/2 h-full items-start ">
                <h4 className="font-medium text-lg md:text-2xl underline text-slate-800 hover:text-purple-700">Software Development</h4>
                <h4 className="font-medium text-lg md:text-2xl underline text-slate-800 hover:text-purple-700">Web Development</h4>
                <h4 className="font-medium text-lg md:text-2xl underline text-slate-800 hover:text-purple-700">Mobile Development</h4>
            ...
            <div className="flex flex-col gap-3  w-1/2 h-full items-start ml-0 md:pl-10">
                ...
                <h4 className="font-medium text-lg md:text-2xl underline text-slate-800 hover:text-purple-700">IoT Solutions</h4>
                <h4 className="font-medium text-lg md:text-2xl underline text-slate-800 hover:text-purple-700">UI/UX</h4>
            </div>
