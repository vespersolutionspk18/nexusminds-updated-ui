...
<div className=" mx-10 flex flex-row  my-2 rounded-3xl bg-radial-gradient pt-16 md:pt-32  pb-16">
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="w-full flex flex-row items-start justify-between px-20 mt-10 gap-20"><ModelCarousel />
          <div className="w-full h-full flex-grow bg-black rounded-2xl text-white"><h3>Schedule a meeting to discuss now</h3>
          <Button />
          </div></div>
        </div>
        <Footer />
