...
<div className=" mx-5 md:mx-10 flex flex-row  my-2 rounded-3xl bg-radial-gradient pt-16 md:pt-32  pb-16">
        ...
        <div className="flex flex-col items-center justify-center">
          <div className="flex flex-row items-center justify-center mt-20 md:mx-20">
            <h3 className="font-semibold text-2xl md:text-4xl text-slate-800">Choose your model</h3>
            
            <h5 className="font-normal text-2xl px-10 pl-10 md:px-64 text-slate-800">We provide flexible collaboration options tailored to suit your current situation.</h5>
          </div>
