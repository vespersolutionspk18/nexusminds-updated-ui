...
<div className=" mx-10 flex flex-row  my-2 rounded-3xl bg-radial-gradient pt-16 md:pt-32  pb-16">
        ...
        <ClientCarousel />
        <div className="flex flex-col items-center justify-center text-5xl text-center font-semibold mt-20"><div className="font-light text-sm bg-purple-100 border-[1px] border-purple-200 rounded-full px-2 py-1">Enterprise Software Development</div><h3>Services we provide</h3><p className="font-light mt-3 text-lg mx-44">We design solutions that transform the digital landscape for businesses, ranging from early-stage startups to Fortune 500 companies.</p></div>
