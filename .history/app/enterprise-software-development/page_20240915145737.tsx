...
<div className=" mx-10 flex flex-row  my-2 rounded-3xl bg-radial-gradient pt-16 md:pt-32  pb-16">
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="w-full flex flex-row items-start justify-between px-10 ml-10 mt-10 gap-10"><ModelCarousel />
          <div className="w-full h-[100%] px-5 py-5 bg-black rounded-2xl text-white"><h3>Schedule a meeting to discuss now</h3>
          <Button />
          </div></div>
        </div>
        <Footer />
