          ...
          <CarouselItem key={index}>
            <div className="p-1">
              <div className=" px-0 py-10 flex flex-row items-start justify-between">
                <div className="w-[40%]"><h3 className=" font-semibold px-10 text-4xl text-slate-800">Scenario 1</h3></div>
                <div className="w-[60%] flex flex-col gap-10 items-start justify-center"><span className="text-2xl font-semibold text-slate-800">{item.title}</span>
