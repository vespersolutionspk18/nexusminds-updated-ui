...
<div className=" mx-5 md:mx-10 flex flex-row  my-2 rounded-3xl bg-radial-gradient pt-16 md:pt-32  pb-16">
        ...
        <div className="flex flex-col md:flex-row items-start justify-between ">
          <div className="md:w-[40%]  my-2 md:mx-0"><h5 className="text-2xl font-semibold">Software development consulting</h5></div>
        ...
        <div className="flex md:flex-row flex-col items-start justify-between ">
          <div className="md:w-[40%]  my-2 md:mx-0"><h5 className="text-2xl font-semibold">Custom software development</h5></div>
        ...
        <SeparatorPurple />
        <div className="flex md:flex-row flex-col items-start justify-between ">
          <div className="md:w-[40%]  my-2 md:mx-0]"><h5 className="text-2xl font-semibold">Software product development</h5></div>
        ...
        <SeparatorPurple />
        <div className="flex md:flex-row flex-col items-start justify-between ">
          <div className="md:w-[40%]  my-2 md:mx-0"><h5 className="text-2xl font-semibold">Software enhancement</h5></div>
        ...
        <SeparatorPurple />
        <div className="flex md:flex-row flex-col items-start justify-between ">
          <div className="md:w-[40%]  my-2 md:mx-0"><h5 className="text-2xl font-semibold">Software integration services</h5></div>
        ...
        <SeparatorPurple />
        <div className="flex md:flex-row flex-col items-start justify-between ">
          <div className="md:w-[40%]  my-2 md:mx-0]"><h5 className="text-2xl font-semibold">Software modernization</h5></div>
        ...
        <div className="flex flex-col items-center justify-center">
          <div className="flex flex-row items-start justify-center mt-20 mx-10 gap-5 md:gap-0 md:mx-20">
            <h3 className="font-semibold text-2xl md:text-4xl text-slate-800">Choose your model</h3>
            
            <h5 className="font-normal text-2xl  md:px-64 text-slate-800">We provide flexible collaboration options tailored to suit your current situation.</h5>
          </div>
          <div className="w-full flex flex-row items-center justify-center px-12 mx-10 md:mx-0 md:px-20 mt-10 gap2-"><ModelCarousel />
</div>
        </div>
        <ContactSection />
        <Footer />
