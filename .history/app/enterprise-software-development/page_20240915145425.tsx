...
<div className=" mx-10 flex flex-row  my-2 rounded-3xl bg-radial-gradient pt-16 md:pt-32  pb-16">
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="w-full flex flex-row items-center justify-center px-20 mt-10 gap-20"><ModelCarousel />
          <div className="bg-black rounded-2xl text-white">Right here</div></div>
        </div>
        <Footer />
