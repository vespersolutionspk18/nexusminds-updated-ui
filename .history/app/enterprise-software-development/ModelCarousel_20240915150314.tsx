          ...
          <CarouselItem key={index}>
            <div className="p-1">
              <div className=" px-0 py-10 flex flex-row items-start justify-between">
                <div><h3 className="px-10 font-semibold text-4xl text-slate-400">Scenario 1</h3></div>
                <div className="flex w-[40%] flex-col gap-10 items-start justify-center"><span className="text-4xl font-semibold text-slate-800">{item.title}</span>
