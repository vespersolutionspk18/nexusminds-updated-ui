      ...
      return (
        <>
          ...
          <motion.button
            layoutId={layout ? `card-${card.title}` : undefined}
            onClick={handleOpen}
            className="rounded-3xl border-white border-[0.5px] frosted-glass-cards h-48 w-56 md:h-[24rem] md:w-96 overflow-hidden flex flex-col items-start justify-start relative z-10"
          >
            <div className="absolute h-full top-0 inset-x-0 bg-gradient-to-b from-black/50 via-transparent to-transparent z-30 pointer-events-none" />
            <div className="relative z-40 p-8">
                <div className="flex flex-row mx-10 pt-32 bg-red-500 border-2 frosted-background px-2 text-slate-800 bg-clip bg-center overflow:hidden">
