...
const CloudProviders = () => {
  return (
    <div className="flex flex-col items-center justify-center mt-36">
        ...
        <p className="text-lg font-regular text-slate-800 mt-2 mb-10 md:mb-0 text-justify">We leverage GCP&apos;s global reach, fiber network, and analytics to boost the productivity of your cloud computing solutions, wherever your business operates. Google Cloud&apos;s AI-powered computing and data management services are vital for modern companies.</p>
        </div>
        <div className="w-full md:w-1/4">
        <div className=" rounded-2xl px-1 py-1">
        ...
        <p className="text-lg font-regular text-slate-800 mt-2 mb-10 md:mb-0 text-justify">Heroku, a multi-language platform-as-a-service and a Nexus favorite, Heroku allows you to build, run, and manage cloud-based apps. It speeds up development and offers a ready-to-use environment for quick code deployment, ideal for startups and mid-sized businesses.</p>
        </div>
